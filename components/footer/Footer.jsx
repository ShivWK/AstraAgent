...
const Footer = () => {
  ...
  return (
    ...
    >
      <div
        className="absolute top-0 left-0 -z-100 flex h-52 w-full flex-col items-center bg-linear-to-tr from-green-400 via-blue-500 to-black p-6 max-md:pb-11 lg:h-72"
        style={{
