...
const AiAssistantSkeleton = () => {
  return (
    <main className="h-dvh animate-pulse pb-18">
      <div className="mx-auto max-w-300">
        ...
        <section className="mx-auto mt-10 flex w-full flex-col gap-8 md:w-[80%] md:gap-4">
          <div className="w-[45%] rounded-xl bg-gray-300 p-4 md:basis-1/2 dark:bg-gray-700">
