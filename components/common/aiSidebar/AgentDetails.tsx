...
const AgentDetails = () => {
  ...
  return (
    <div className="section__agent-card rounded-primary dark:bg-primary-dark-bg h-auto p-2">
      <div
        onClick={(e) => e.stopPropagation()}
        className="section__agent-card rounded-primary dark:bg-primary-dark-bg mt-1 flex w-full flex-col items-center gap-2 md:flex-row md:gap-4"
      >
        <Image
        ...
        <div>
          <p className="line-clamp-1 text-2xl font-semibold max-md:text-center">
            {selectedAgent?.name[0].toUpperCase() +
              selectedAgent?.name.slice(1)}
          </p>
          <div className="flex items-center max-md:gap-1 md:flex-col md:items-start">
            <p className="max-md:text-center max-md:text-lg md:mt-1 md:font-medium">
              Current Agent
            </p>
            <span className="md:hidden">:</span>
            <p className="line-clamp-1 italic max-md:text-center max-md:text-lg md:-mt-1">
              {selectedAgent?.title}
            </p>
          </div>
        </div>
      ...
      <div className="mt-3 rounded-lg bg-linear-to-tr from-blue-500 to-gray-400/30 p-2 backdrop-blur-md">
        <div className="rounded-primary w-full">
          ...
          <p className="text-md -mt-0.5 font-medium">Trinity Large Preview</p>
          ...
          <p className="text-white">Best for chat, emotions, storytelling</p>
        </div>
