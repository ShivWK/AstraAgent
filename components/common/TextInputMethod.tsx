...
const TextInputMethod = () => {
  return (
    <form className="absolute bottom-6 left-1/2 z-40 flex w-[95%] -translate-x-1/2 items-end gap-2 rounded-2xl border-2 border-blue-900 bg-black py-2 pr-2 pl-4 md:w-[88%]">
      <textarea
        rows={1}
